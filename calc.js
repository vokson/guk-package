...
var RC_diagram = NORM.get3LinearDiagram(NORM.HEAVY_CONCRETE, 'B25', NORM.SHORT_TERM_LOAD).map(function (item) {
...
var REBAR_X_OriginalCoordinates = [0.1, 0.3];
var REBAR_Y_OriginalCoordinates = [0.05, 0.05];
...
/*
 function compareTwoPointsByValue(a, b) {
 if (a[1] === b[1]) {
