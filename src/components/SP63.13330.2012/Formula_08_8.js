...
function calculate(obj) {
    return (obj[CONST.VAR_Rs] * obj[CONST.VAR_As] - obj[CONST.VAR_Rsc] * obj[CONST.VAR_As$] -
        obj[CONST.VAR_Rb] * (obj[CONST.VAR_T_SECTION_FLANGE_WIDTH] - obj[CONST.VAR_SECTION_WIDTH]) *
        obj[CONST.VAR_T_SECTION_FLANGE_HEIGHT]) / (obj[CONST.VAR_Rb] * obj[CONST.VAR_SECTION_WIDTH]);
}
