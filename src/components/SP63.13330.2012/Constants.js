...
export const VAR_CONCRETE_CLASS = "concreteCompressionClass";
export const VAR_CONCRETE_TENSION_CLASS = "concreteTensionClass";
export const VAR_CONCRETE_DENSITY = "density";
export const VAR_CONCRETE_HUMIDITY_IN_PERCENTS = "humidityPercentage";
export const VAR_CONCRETE_TYPE = "concreteType";
...
export const VAR_REBAR_CLASS = "rebarClass";
...
export const VAR_STRESS_TYPE = "stressType";
