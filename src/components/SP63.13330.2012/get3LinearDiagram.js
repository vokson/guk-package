...
export default function (type = null, classname = null, loadCondition = null, humidity = null, isReductionFactorToBeApplied = false) {
    ...
    if (loadCondition === CONST.LONG_TERM_LOAD) {
        ...
        let array_eb0_eb2 = strain_function(type, classname, humidity, CONST.COMPRESSION);
        let array_ebt0_ebt2 = strain_function(type, classname, humidity, CONST.TENSION);

        if (array_eb0_eb2 !== null) {
            [eb0, eb2,] = array_eb0_eb2;
        }

        if (array_ebt0_ebt2 !== null) {
            [ebt0, ebt2,] = array_ebt0_ebt2;
        }
