...
* *number* __type__ - тип бетона;
* *string* __classname__ - класс бетона по прочности на сжатие;
...
* *number* __type__ - тип бетона;
* *string* __classname__ - класс бетона по прочности на осевое растяжение;
...
* *number* __type__ - тип бетона;
* *string* __classname__ - класс бетона по прочности на сжатие (только тяжелый, напрягающий, мелкозернистый);
* *number* __Ybi = 1.0__ - коэффициент, понижающий **Rb**, > 0;
* *number* __Ybti = 1.0__ - коэффициент, понижающий **Rbt**, > 0;
* *number* __loadType__ - тип нагрузки: кратковременная или длительная (см. константы);
...
* *string* __classname__ - класс арматуры;
