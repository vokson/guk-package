...
```
---
*number* __formula_08_4__ (*number* __Rb__, *number* __Rsc__, *number* __As1__, *number* __b__, *number* __h0__, *number* __x__, *number* __a1__)
...
* __As1__ - площадь сжатой арматуры, >= 0;
* __b__ - ширина прямоугольного сечения, >= 0;
