...
```
---
*number* __formula_08_10__ (*number* __N__, *number* __e__, *number* __Rsc__, *number* __A1s__, *number* __Rb__, *number* __b__, *number* __x__, *number* __h0__, *number* __a1__)

Возвращает значение выражения **Rb\*b\*x\*(h0-0.5\*x)+Rsc\*A1s\*(h0-a1)-N\*e** по формуле 8.10, которое должно быть >= 0
* __N__ - продольная сила от внешней нагрузки, >= 0;
* __e__ - расстояние по формуле 8.11, >= 0;
* __Rb__ - предел прочности бетона на сжатие, >= 0;
* __Rsc__ - предел прочности арматуры на сжатие, >= 0;
* __A1s__ - площадь сжатой арматуры, >= 0;
* __b__ - ширина прямоугольного сечения, >= 0;
...
```javascript
NORM.formula_08_10(300, 0.1, 1000, 2, 100, 15, 20, 45, 5)
// 1129970
```
---
*number* __formula_08_11__ (*number* __e0__, *number* __nu__, *number* __h0__, *number* __a1__)

Возвращает значение **e** по формуле 8.11
* __e0__ - эксцентриситет приложения силы по п.8.1.7, >= 0;
* __nu__ - коэффициент влияния прогиба на несущую способность, определяемый по п.8.1.15, >= 0;
* __h0__ - рабочая высота сечения, >= 0;
* __a1__ - расстояние от равнодействующей в арматуре S' до ближайшей грани сечения, >= 0;
...
```javascript
NORM.formula_08_11(1, 5, 40, 5)
// 22.5
```
---
*number* __formula_08_12__ (*number* __N__, *number* __Rs__, *number* __As__, *number* __Rsc__, *number* __A1s__, *number* __Rb__, *number* __b__)

Возвращает значение **x** по формуле 8.12
* __N__ - продольная сжимающая сила, >= 0;
* __Rb__ - предел прочности бетона на сжатие, > 0;
* __Rs__ - предел прочности арматуры на растяжение, >= 0;
* __Rsc__ - предел прочности арматуры на сжатие, >= 0;
* __As__ - площадь растянутой арматуры, >= 0;
...
```javascript
NORM.formula_08_12(500, 100, 2, 100, 1, 10, 15)
// 4
```
---
*number* __formula_08_13__ (*number* __N__, *number* __Rs__, *number* __As__, *number* __Rsc__, *number* __A1s__, *number* __Rb__, *number* __b__, *number* __h0__, *number* __Xi_R__)

Возвращает значение **x** по формуле 8.13
* __N__ - продольная сжимающая сила, >= 0;
* __Rb__ - предел прочности бетона на сжатие, >= 0;
* __Rs__ - предел прочности арматуры на растяжение, >= 0;
* __Rsc__ - предел прочности арматуры на сжатие, >= 0;
...
* __b__ - ширина прямоугольного сечения, >= 0;
* __h0__ - рабочая высота сечения, > 0;
* __Xi_R__ - граничная относительная высота сжатой зоны, >= 0;
...
```javascript
NORM.formula_08_13(500, 100, 2, 100, 1, 10, 15, 45, 0.3)
// 4.74146...
```
---
